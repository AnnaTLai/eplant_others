(function() {
	...
	*/
	Eplant.Views.PublicationView = function(geneticElement) {
		...
		$(this.domContainer).attr('id','geneInfo'+this.geneticElement.identifier.replace('.',''));
	...
	Eplant.Views.PublicationView.prototype.loadData = function() {
		$.when(Eplant.Views.PublicationView.Params.htmlPage).then($.proxy(function( res ) {
			...
			.DataTable( {
				...
				ajax: {
					type: 'GET',
					url: '//bar.utoronto.ca/eplant_soybean/cgi-bin/publications_by_locus.php',
					async: true,
			...
			.DataTable( {
				...
				ajax: {
					type: 'GET',
					url: '//bar.utoronto.ca/eplant_soybean/cgi-bin/generifs_by_locus.php',
					async: true,
					data: { locus: this.geneticElement.identifier },
					dataType: 'json',
					"dataSrc": "result"
