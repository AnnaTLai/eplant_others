...
sub getLink {
	...
	my $dataDir = "/DATA/ePlants_Data/eplant_soybean/protein_structures/";	# SymLink to pdb files
	my $ePlant = "//bar.utoronto.ca/eplant_soybean/pdb/";	# Link
...
sub getPrediction {
	...
	# Query database and find the results
	my $dbh = DBI->connect('DBI:mysql:eplant_soybean', 'hans', 'un1pr0t') or end("Could not connect to database!.");
