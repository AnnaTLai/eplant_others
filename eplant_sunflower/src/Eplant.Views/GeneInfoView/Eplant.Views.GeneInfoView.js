	...
	Eplant.Views.GeneInfoView.prototype.loadData = function() {
		$.when(Eplant.Views.GeneInfoView.Params.htmlPage).then($.proxy(function( res ) {
			...
			var getGeneSummary = $.ajax({
				type: 'GET',
				url: '//bar.utoronto.ca/eplant_sunflower/cgi-bin/gene_summary_by_locus.php?locus=' + this.geneticElement.identifier,
				dataType: 'json',
			...
			var getGeneStructure = $.ajax({
				type: "GET",
				dataType: "json",
				url: '//bar.utoronto.ca/eplant_sunflower/cgi-bin/gene_structure_by_locus.php?locus='+this.geneticElement.identifier,
				success: $.proxy(function(data) {
					...
					if (this.geneticElementType === 'protein_coding') {
						$.ajax({
							type: "GET",
							dataType: "json",
							url: '//bar.utoronto.ca/eplant_sunflower/cgi-bin/get_protein_sequence_by_identifier.php?locus='+this.geneticElement.identifier,
					...
					var getGenomeSequence = $.ajax({
						type: "GET",
						dataType: "json",
						url: '//bar.utoronto.ca/eplant_sunflower/cgi-bin/get_sequence_by_identifier.php?locus=' + this.geneticElement.identifier,
						success: $.proxy(function(data) {
