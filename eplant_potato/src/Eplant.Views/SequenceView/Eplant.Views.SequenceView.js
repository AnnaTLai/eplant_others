(function() {
	...
	*/
	Eplant.Views.SequenceView = function(geneticElement) {
		...
		this.domContainer.src = "https://phytozome.jgi.doe.gov/jbrowse/index.html?data=genomes/Stuberosum&loc=" + this.geneticElement.chromosome.identifier + ":" + this.geneticElement.start + ".." + this.geneticElement.end + "&tracks=Transcripts,PASA_assembly,Blastx_protein,Blatx_BasalEudicot&highlight=";
