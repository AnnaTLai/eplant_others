...
Eplant.Views.ChromosomeView.Chromosome.prototype.draw = function() {
	...
	if (yBottomPosition > ZUI.height) {		// Clip
		...
		this.higherRangeVO.content = mb + " Mb";
		this.higherRangeVO.x = (yBottomPosition > ZUI.height - 11) ? xPosition + halfWidth + 5 : xPosition + halfWidth - 17;
		this.higherRangeVO.y = (yBottomPosition > ZUI.height - 11) ? ZUI.height - 6 : yBottomPosition + 5;
		this.higherRangeVO.draw();
	}
