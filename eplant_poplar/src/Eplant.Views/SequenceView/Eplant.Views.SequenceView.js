	...
	*/
	Eplant.Views.SequenceView = function(geneticElement) {
		...
		if (geneticElement == null) {
			alert("Sequence viewer might not load correctly");
		}
		if (geneticElement.start == null) {
			alert("Sequence viewer might not load correctly");
		}
		...
		// Poplar
		//window.alert(this.geneticElement.start + " " + this.geneticElement.end);
		this.domContainer.src = "https://phytozome.jgi.doe.gov/jbrowse/index.html?data=genomes/Ptrichocarpa&loc=" + this.geneticElement.chromosome.identifier + ":" + this.geneticElement.start + ".." + this.geneticElement.end + "&tracks=Transcripts,Alt_Transcripts,PASA_assembly,Blastx_protein,Blatx_Plant_protein&highlight=";
