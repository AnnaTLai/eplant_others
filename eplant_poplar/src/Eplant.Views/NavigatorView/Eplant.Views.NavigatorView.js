...
(function() {
  ...
  Eplant.Views.NavigatorView = function(geneticElement) {
    ...
    if (this.name) {
      ...
      species = "Poplar"; // change for other species
    ...
    geneticElementidetifierDOM = this.geneticElement.identifier.replace(".", "_"); // Anna modified
    console.log("The gene identifier in Navigator view for creating div is:" + geneticElementidetifierDOM)
    $(this.domContainer).attr('id', 'NavView' + geneticElementidetifierDOM);
  ...
  Eplant.Views.NavigatorView.prototype.loadNavigatorData = function() {
    var treeContainer = $(this.domContainer).find('#NavView' + geneticElementidetifierDOM).selector;
    //var that = this;
    $.ajax({
      type: "GET",
  ...
  Eplant.Views.NavigatorView.prototype.active = function() {
    ...
    var treeContainer = $(this.domContainer).find('#NavView' + geneticElementidetifierDOM).selector;
    $("#NavView" + geneticElementidetifierDOM).css({
      'overflow': 'auto'
    });
    $(treeContainer).css({
      'visibility': 'visible',
