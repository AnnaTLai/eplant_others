...
try:
    ...
    if (includePredicted == "yes" or includePredicted == "no"):
        url = '//bar.utoronto.ca/eplant_poplar/cgi-bin/suba3.cgi?id=' + id + '&include_predicted=' + includePredicted
    else:
        url = '//bar.utoronto.ca/eplant_poplar/cgi-bin/suba3.cgi?id=' + id + '&include_predicted=yes'
