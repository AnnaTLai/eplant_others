(function() {
  ...
  Eplant.isAnimateActiveViewChange = false; // Whether activeView changes are animated JW: transitions deprecated
  ...
  Eplant.bindEvents = function() {
    ...
    var eventListener = new ZUI.EventListener("add-geneticElement", null, function(event, eventData, listenerData) {
      ...
      //when the heatmap view is added bring this line back
