...
(function() {
  ...
  Eplant.Views.NavigatorView = function(geneticElement) {
    ...
    console.log("barley loaded constructor of eplant")
    ...
    if (this.name) {
      ...
      species = "barley"; // change for other species
    ...
    $(this.domContainer).attr('id', 'NavView' + this.geneticElement.identifier);
  ...
  Eplant.Views.NavigatorView.prototype.loadNavigatorData = function() {
    var treeContainer = $(this.domContainer).find('#NavView' + this.geneticElement.identifier).selector;
    var url = '//bar.utoronto.ca/webservices/eplant_navigator/cgi-bin/eplant_navigator_service.cgi?primaryGene=' + query + '&species=' + species + '&dataset=Developmental&checkedspecies=arabidopsis_poplar_medicago_soybean_rice_barley_maize_potato_tomato_grape'
    //var that = this;
    ...
    $.ajax({
      ...
      success: function(data) {
        console.log("inside the success of the ajax call to the webservies api")
        console.log(data);
  ...
  Eplant.Views.NavigatorView.prototype.active = function() {
    ...
    var treeContainer = $(this.domContainer).find('#NavView' + this.geneticElement.identifier).selector;
    $("#NavView" + this.geneticElement.identifier).css({
      'overflow': 'auto'
    });
    $(treeContainer).css({
      'visibility': 'visible',
