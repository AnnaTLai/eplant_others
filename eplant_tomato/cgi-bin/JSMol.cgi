...
sub getLink {
	...
	my $dataDir = "/DATA/ePlants_Data/eplant_tomato/protein_structures/";	# SymLink to pdb files
	my $ePlant = "//bar.utoronto.ca/eplant_tomato/pdb/";	# Link
...
sub getPrediction {
	...
	# Query database and find the results
	my $dbh = DBI->connect('DBI:mysql:eplant_tomato', 'hans', 'un1pr0t') or end("Could not connect to database!.");
