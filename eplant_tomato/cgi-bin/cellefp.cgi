...
try:
    ...
    if (includePredicted == "yes" or includePredicted == "no"):
        url = 'http://bar.utoronto.ca/eplant_tomato/cgi-bin/suba3.cgi?id=' + id + '&include_predicted=' + includePredicted
    else:
        url = 'http://bar.utoronto.ca/eplant_tomato/cgi-bin/suba3.cgi?id=' + id + '&include_predicted=yes'
