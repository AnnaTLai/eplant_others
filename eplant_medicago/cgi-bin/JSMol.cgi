...
sub getLink {
	...
	my $dataDir = "/DATA/ePlants_Data/eplant_medicago/protein_structures/";	# SymLink to pdb files
	my $ePlant = "//bar.utoronto.ca/eplant_medicago/pdb/";	# Link
...
sub getPrediction {
	...
	# Query database and find the results
	my $dbh = DBI->connect('DBI:mysql:eplant_medicago', 'hans', 'un1pr0t') or end("Could not connect to database!.");
