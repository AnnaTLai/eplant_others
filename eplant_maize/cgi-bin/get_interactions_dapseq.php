...
* @MySQL	Matt Ierullo
* @Date		July, 2014
* @Usage	http://bar.utoronto.ca/eplant_maize/cgi-bin/new_get_interactions.php?request=[{"agi":"At1g02130"},{"agi":%"At4g23810"},{"agi":"At3g01090"}]	
*/
...
class Interactions
{
	...
	private function cleanInput($data) {
		...
		if (preg_match("/^GRMZM\d*.G\d+$/i", $data)) {
			return $data;	
		} else {
	...
	private function connect() {
		$mysqli = new mysqli("localhost", "InteractionsUser", "InteractionsUser", "maize_interactions");
